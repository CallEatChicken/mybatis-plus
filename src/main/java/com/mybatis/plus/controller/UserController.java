...
public class UserController{
  ...
  public Object getUserByWrapper() {
      return userServiceImpl.selectListByWrapper(new QueryWrapper<User>()
              .lambda().like(User::getName, "w"));
  }
	
//	@GetMapping("/api")
//    public R testError(String test) {
...
//        System.err.println("插入一条数据：" + userService.save(new User(66066L, "张三", AgeEnum.TWO, 1)));
